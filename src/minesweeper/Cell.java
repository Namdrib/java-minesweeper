...
public interface Cell
{
	 ...
	 * 
	 * @param number
	 *            input number to set this.number
	 */
	 ...
	 * 
	 * @return <code>true</code> if the number is <code>-1</code>,
	 ...
	 * <li>its number: if the Cell has no mines. If the Cell is opened and
	 * blank, print a zero.
	 * </ul>
	 * <p>
